...
export default function AccountPage() {
  ...
  const copy = locale === 'ar'
    ? {
        ...
        logout: 'تسجيل الخروج',
        supportReset: 'لا يوجد استرجاع تلقائي لكلمة المرور حالياً. إذا فقدت الوصول تواصل مع الدعم.',
    ...
    : {
        ...
        logout: 'Log out',
        supportReset: 'There is no automatic password reset yet. Contact support if you lose access.',
